...
export interface InventoryItem {
  ...
  latest_market_stage?: string | null;
  latest_trade_id?: string | null;
  latest_send_until?: string | null;
  latest_receive_until?: string | null;
  latest_settlement?: string | null;
  latest_causer?: string | null;
  latest_cancellation_reason?: string | null;
  latest_market_refund?: unknown | null;
